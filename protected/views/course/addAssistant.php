...
<fieldset>
    ...
    <?php echo $form->textFieldRow($model, 'email', array('hint'=>'You must add them at ' . CHtml::link('Create Assistant', '/assistant/create?returnUrl='.urlencode('/course/addAssistant?courseId='.$course->id)) . ' first.')); ?>
