...
<fieldset>
    ...
    <?php echo $form->textFieldRow($model, 'email', array('hint'=>'You must add them at ' . CHtml::link('Create Instructor', '/instructor/create?returnUrl='.urlencode('/course/addInstructor?courseId='.$course->id)) . ' first.')); ?>
